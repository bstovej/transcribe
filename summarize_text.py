...
def process_transcriptions(input_dir=INPUT_DIR, output_dir=OUTPUT_DIR):
    """
    Reads transcribed files from input_dir and saves summaries to output_dir.
    """
    ...
    for file_path in transcribed_files:
        ...
        try:
            ...
            if summary:
                # Save to output folder with a -summarized.md suffix
                output_file = output_path / file_path.name.replace("-transcribed.txt", "-summarized.md")
